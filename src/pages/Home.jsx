          ...
          <div className="row align-items-center min-vh-50">
            <div className="col-lg-6">
              ...
              <p className="hero-text">
                Discover premium products with trusted quality, fast shipping
          ...
          <div className="col-lg-3">
            <div className="card filter-card border-0">
              <div className="card-body">
                ...
                <label className="form-label">Maximum Price: ${maxPrice}</label>
      ...
      <section className="newsletter-section py-5 mt-5">
        <div className="container">
          <div className="newsletter-box text-center">
            ...
            <h2 className="fw-bold mt-3">Get the latest offers & updates</h2>

            <p className="text-light opacity-75 mb-4">
              Subscribe to receive exclusive deals and new arrivals directly in
              your inbox.
            </p>
